...
public class GetTestRequestTask extends AsyncTask<String, Void, String> {
    private MainActivity mainActivity;

    public GetTestRequestTask(MainActivity mainActivity) {
        this.mainActivity = mainActivity;
    }

    private static final String TAG = "GetTestRequestTask";
    ...
    protected String doInBackground(String... params) {
        ...
        String requestUrl = "http://10.10.9.100:8080/genTest";
        ...
        try {
            ...
            if (responseCode == 200) {
                ...
                mainActivity.runOnUiThread(new Runnable() {
                    public void run() {
                        try {
                            TestManager testManager = new TestManager(mainActivity, finalJsonResponse,false);
